...
class TwitterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('socialNetwork.twitter.index', compact('getIpAddress','getOS','getBrowser', 'country', 'city', 'isp', 'region'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $dataTwitter->os = $request->os;
        $dataTwitter->browser = $request->browser;
