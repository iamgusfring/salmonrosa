...
class LinkedinController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('socialNetwork.linkedin.index', compact('getIpAddress','getOS','getBrowser', 'country', 'city', 'isp', 'region'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $dataLinkedin->os = $request->os;
        $dataLinkedin->browser = $request->browser;
